...
instance = nova.servers.create(name="arnab_prod_server_without_docker", image=image, flavor=flavor, key_name='de1-course-snic-key',userdata=userdata, nics=nics,security_groups=secgroups)
