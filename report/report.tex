...
\lstinputlisting[style=python, caption={consumer-task-2-B.py -- consumer running on VM B}]{../consumer-task-2-B.py}
...
\newpage
% =============================================================================
\section{Task 4 (Extra): Splitting and Merging with Apache Pulsar}
% =============================================================================
...
\subsubsection{Producer -- producer-task-4.py}

\lstinputlisting[style=python, caption={producer-task-4.py -- splits the input string and publishes words}]{../producer-task-4.py}

\subsubsection{Worker Consumer/Producer -- consumer-task-4-worker.py}

\lstinputlisting[style=python, caption={consumer-task-4-worker.py -- applies conversion and forwards results}]{../consumer-task-4-worker.py}

\subsubsection{Merger Consumer -- consumer-task-4-merger.py}

\lstinputlisting[style=python, caption={consumer-task-4-merger.py -- collects results and reassembles the string}]{../consumer-task-4-merger.py}
...
\lstinputlisting[style=shell, caption={setup\_vm.sh -- VM provisioning script}]{../setup_vm.sh}
